...
description: |
  ...
  Do NOT trigger when: line-level code review (use code-reviewer), single function review, implementasi aktif, atau pertanyaan struktural ringan seperti "di mana letakkan file X" — untuk itu gunakan code-reviewer agar tidak membuang extended thinking budget.
